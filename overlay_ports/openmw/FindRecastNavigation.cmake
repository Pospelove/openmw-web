...
if(NOT RECAST_LIBRARY)
    ...
    set(RECAST_LIBRARY_RELEASE /openmw-web/vcpkg/installed/wasm32-emscripten/lib/librecast.a)
    set(RECAST_LIBRARY_DEBUG /openmw-web/vcpkg/installed/wasm32-emscripten/debug/lib/librecast.a)
...
if(NOT DETOUR_LIBRARY)
    ...
    set(DETOUR_LIBRARY_RELEASE ${RECAST_LIBRARY_RELEASE})
    set(DETOUR_LIBRARY_DEBUG ${RECAST_LIBRARY_DEBUG})
    include(SelectLibraryConfigurations)
...
if(NOT DEBUGUTILS_LIBRARY)
    ...
    set(DEBUGUTILS_LIBRARY_RELEASE ${RECAST_LIBRARY_RELEASE})
    set(DEBUGUTILS_LIBRARY_DEBUG ${RECAST_LIBRARY_DEBUG})
    include(SelectLibraryConfigurations)
...
set(RECAST_INCLUDE_DIR /openmw-web/vcpkg/installed/wasm32-emscripten/include/recast/Recast)
